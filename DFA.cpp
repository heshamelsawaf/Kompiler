...
std::string get_key(std::set<sid_t> &s) {
    return "";
}

std::string get_token_type(std::set<sid_t> &s, machine &fa, bool &is_final) {

    return "";
}

std::string get_token_type(std::vector<sid_t> &s, machine &fa, bool &is_final) {
